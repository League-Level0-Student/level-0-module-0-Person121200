...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent e) {
		...
		if (started) {
			...
			if (mouseColor == A) scare();			//13.  If the mouse is on the end color, pop up a message to tell them they won!
			//    (you will need to get the number of the END COLOR by moving the mouse over it)
			if (mouseColor == B) JOptionPane.showMessageDialog(null, "You won");
	...
	private void scare() {
		...
		showScaryImage("showScaryImage.jpeg");
		playScarySound("standardScarySound.wav");
	}
